...
void setup() {
  ...
  String response = getRequest("https://jsonplaceholder.typicode.com/todos/50");
  ...
  Serial.println(json);
  Serial.println(json["userId"]);
  Serial.println(json["id"]);
  Serial.println(json["title"]);
}
